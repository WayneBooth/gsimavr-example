...
# compiler
xCFLAGS=-I. $(INC) -g -mmcu=$(MCU) -O$(OPTLEVEL) \
...
#	-std=gnu99 -pedantic -Wstrict-prototypes -fwhole-program \
...
fuse:
	$(AVRDUDE) -c $(AVRDUDE_PROGRAMMERID) -B 10  \
	 ...
	 -V -F -U lfuse:w:0xDE:m -U hfuse:w:0xd9:m -U efuse:w:0x07:m
...
$(GDBINITFILE): $(TRG)
	...
	@echo
	@echo "Use 'avr-gdb -tui -x $(GDBINITFILE)'"
